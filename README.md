...
This software is <B>not</B> Open Source nor is it Free Software.
It is cost-free to use and may be freely redistributed under the terms of its licence.

<I>However, it may not be used by anyone for military purposes,
in weapon systems, or under military contract.  It may not be used by any military organization.  The code generated by cogent is similarly restricted.</I>

Read (the licence file)[LICENCE.md].
...
The last three are useful if you have a naming system in your code but you don't want to clutter up the diagram with extra charaters.  For example you might define
...
Note that the entrypoint and exitpoint pseudostates are not renamed.
